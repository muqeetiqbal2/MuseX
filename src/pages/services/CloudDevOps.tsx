...
import { Cloud, Server, GitBranch, Shield, Zap, TrendingUp } from "lucide-react";
...
const CloudDevOps = () => {
  const features = [
    ...
    },
    {
      ...
      description: "Continuous integration and deployment for faster releases.",
    },
    {
      icon: Shield,
      title: "Security & Compliance",
      description: "Cloud security best practices and compliance automation.",
    },
    {
      icon: Zap,
      title: "Auto-Scaling",
    ...
    },
    {
      ...
      description: "24/7 infrastructure monitoring with intelligent alerting.",
    },
  ];
  ...
  const process = [
    {
      step: "01",
      title: "Assessment",
      description: "Analyze current infrastructure and define cloud strategy.",
    },
    {
      step: "02",
      title: "Architecture",
      description: "Design scalable, resilient cloud architecture.",
    },
    {
      step: "03",
      title: "Migration",
    ...
    },
    {
      step: "05",
      title: "Optimization",
      description: "Fine-tune performance and reduce cloud costs.",
    },
    {
      step: "06",
      title: "Support",
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto text-center space-y-6 animate-fade-in-up">
            <div className="inline-flex items-center space-x-2 bg-card border border-accent/20 rounded-full px-4 py-2 text-sm mb-4">
              ...
              <span className="text-foreground/80">Cloud & DevOps Solutions</span>
            </div>
            <h1 className="text-5xl md:text-6xl font-bold text-primary">
              Cloud Infrastructure & DevOps
            </h1>
            <p className="text-xl text-muted-foreground">
              Build scalable, secure cloud infrastructure with modern DevOps practices
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground">
              Complete cloud and DevOps solutions for modern businesses
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground mb-12">
              Enterprise-grade cloud and DevOps technologies
            </p>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground">
                Strategic approach to cloud transformation
              </p>
            </div>
      ...
      <section className="py-20 bg-gradient-to-br from-primary via-primary to-primary/90 text-primary-foreground">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            <h2 className="text-4xl md:text-5xl font-bold">Ready to Transform Your Infrastructure?</h2>
            <p className="text-xl text-primary-foreground/90">
              Modernize your infrastructure with cloud and DevOps expertise
            </p>
