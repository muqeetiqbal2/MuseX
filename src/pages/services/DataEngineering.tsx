...
import { Database, BarChart, Workflow, Shield, Zap, TrendingUp } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "Automated ETL/ELT pipelines for data ingestion and transformation.",
    },
    {
      icon: BarChart,
      title: "Data Warehousing",
      description: "Scalable data warehouses with Snowflake, BigQuery, and Redshift.",
    },
    {
      icon: Workflow,
      title: "Data Integration",
      description: "Connect disparate data sources into unified analytics platform.",
    },
    {
      icon: Shield,
      title: "Data Governance",
      description: "Data quality, security, and compliance frameworks.",
    },
    {
      icon: Zap,
      title: "Real-time Processing",
      description: "Stream processing for real-time analytics and insights.",
    },
    {
      icon: TrendingUp,
      title: "BI Dashboards",
  ...
  const process = [
    {
      step: "01",
      title: "Assessment",
      description: "Evaluate current data landscape and analytics requirements.",
    },
    {
      step: "02",
      title: "Architecture",
      description: "Design scalable data architecture and processing pipelines.",
    },
    {
      step: "03",
      title: "Implementation",
      description: "Build ETL pipelines and data warehousing solutions.",
    },
    {
      step: "04",
      title: "Integration",
      description: "Connect data sources and establish data flows.",
    },
    {
      step: "05",
      title: "Visualization",
      description: "Create dashboards and analytics tools for insights.",
    },
    {
      step: "06",
      title: "Optimization",
      description: "Monitor performance and optimize data processing costs.",
    },
  ];
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto text-center space-y-6 animate-fade-in-up">
            <div className="inline-flex items-center space-x-2 bg-card border border-accent/20 rounded-full px-4 py-2 text-sm mb-4">
              ...
              <span className="text-foreground/80">Data Engineering & Analytics</span>
            </div>
            <h1 className="text-5xl md:text-6xl font-bold text-primary">
              Data Engineering & Analytics
            </h1>
            <p className="text-xl text-muted-foreground">
              Transform raw data into actionable insights with modern data platforms
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground">
              End-to-end data engineering and analytics solutions
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground mb-12">
              Modern data engineering and analytics platforms
            </p>
      ...
      <section className="py-20 bg-gradient-to-br from-primary via-primary to-primary/90 text-primary-foreground">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            <h2 className="text-4xl md:text-5xl font-bold">Ready to Unlock Your Data?</h2>
            <p className="text-xl text-primary-foreground/90">
              Build a modern data platform that drives business decisions
            </p>
