...
import { Boxes, GitBranch, Shield, Zap, Database, TrendingUp } from "lucide-react";
...
const Microservices = () => {
  const features = [
    {
      ...
      description: "Design independent, deployable microservices architecture.",
    },
    {
      icon: GitBranch,
      title: "API Gateway",
      description: "Centralized API gateway for routing and load balancing.",
    },
    {
      icon: Shield,
      title: "Service Mesh",
      description: "Secure service-to-service communication with Istio.",
    },
    {
      icon: Zap,
      title: "Event-Driven",
      description: "Asynchronous messaging with Kafka and RabbitMQ.",
    },
    {
      icon: Database,
      title: "Database per Service",
      description: "Isolated data stores for each microservice.",
    },
    {
      icon: TrendingUp,
      title: "Observability",
      description: "Distributed tracing, logging, and monitoring.",
    },
  ];
  ...
  const process = [
    ...
    },
    {
      step: "02",
      title: "Architecture",
      description: "Design microservices architecture and communication patterns.",
    },
    {
      step: "03",
      title: "Development",
      description: "Build independent services with well-defined APIs.",
    },
    {
      step: "04",
      title: "Containerization",
      description: "Package services in containers for consistent deployment.",
    },
    {
      step: "05",
      title: "Orchestration",
      description: "Deploy and manage services with Kubernetes.",
    },
    {
      step: "06",
      title: "Monitoring",
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto text-center space-y-6 animate-fade-in-up">
            <div className="inline-flex items-center space-x-2 bg-card border border-accent/20 rounded-full px-4 py-2 text-sm mb-4">
              ...
              <span className="text-foreground/80">Microservices Architecture</span>
            </div>
            <h1 className="text-5xl md:text-6xl font-bold text-primary">
              Microservices Architecture
            </h1>
            <p className="text-xl text-muted-foreground">
              Build scalable, resilient systems with modern microservices architecture
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground mb-12">
              Cloud-native technologies for microservices
            </p>
      ...
      <section className="py-20 bg-gradient-to-br from-primary via-primary to-primary/90 text-primary-foreground">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            <h2 className="text-4xl md:text-5xl font-bold">Ready to Go Microservices?</h2>
            <p className="text-xl text-primary-foreground/90">
              Transform your architecture for scalability and resilience
            </p>
